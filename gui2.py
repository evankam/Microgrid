...
label_0 = Label(root2, text = "Shweta")
label_1 = Label(root2, text = "Liezl")
label_2 = Label(root2, text = "Evan")
label_3 = Label(root2, text = "Joer")
...
def animate(i): #to create a liveplot
    ...
    c.clear()
    d.clear()
    a.plot(xlist, ylist, marker = 'o', markerfacecolor = 'blue', color = 'blue', label = "Shweta")
    b.plot(x2list,y2list, marker = 'o', markerfacecolor = 'yellow', color = 'yellow', label  = "Liezl")
    c.plot(x3list, y3list, marker = 'o', markerfacecolor = 'green', color = 'green', label = "Evan")
    d.plot(x4list,y4list, marker = 'o', markerfacecolor = 'red', color = 'red', label  = "Joer")
